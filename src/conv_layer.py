...
class conv_pool_layer(object):
    ...
    def __init__(self, rng, input, filter_shape, image_shape, zero_pad=True, poolsize=(2, 2), read_file=False, W_input=None, b_input=None, relu_param=0.1):
        ...
        self.output = relu(pooled_out + self.b.dimshuffle('x', 0, 'x', 'x'), relu_param)
